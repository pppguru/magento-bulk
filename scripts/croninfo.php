<?php
    ...
    function loadSettings()
    {
        ...
        $settings = array();
        $settings['host'] = iterator_to_array($xpath->evaluate("/config/global/resources/default_setup/connection/host"))[0]->nodeValue;
        $settings['login'] = iterator_to_array($xpath->evaluate("/config/global/resources/default_setup/connection/username"))[0]->nodeValue;
        $settings['pass'] = iterator_to_array($xpath->evaluate("/config/global/resources/default_setup/connection/password"))[0]->nodeValue;
        $settings['db'] = iterator_to_array($xpath->evaluate("/config/global/resources/default_setup/connection/dbname"))[0]->nodeValue;
        $settings['prefix'] = iterator_to_array($xpath->evaluate("/config/global/resources/default_setup/db/table_prefix"))[0]->nodeValue;
