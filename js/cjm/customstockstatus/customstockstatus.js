...
//    if(spConfig.config.dynamics == 1 && spConfig.config.showbottom == 1){  // by default
	if(spConfig.config.dynamics == 1 && spConfig.config.showbottom == 1 && $$('.product-options-bottom').length > 0){ // Matthew
