...
Opentip=function(){function c(a,b,e,d){var l,h,f,g,k=this;if(this.id=++c.lastId,this.debug("Creating Opentip."),c.tips.push(this),this.adapter=c.adapter,l=this.adapter.data(a,"opentips")||[],l.push(this),this.adapter.data(a,"opentips",l),this.triggerElement=this.adapter.wrap(a),1<this.triggerElement.length)throw Error("You can't call Opentip on multiple elements.");if(1>this.triggerElement.length)throw Error("Invalid element.");this.waitingToHide=this.waitingToShow=this.visible=this.loading=this.loaded=
...
(d.targetJoint=(new c.Joint(d.tipJoint)).flip());this.showTriggers=[];this.showTriggersWhenVisible=[];this.hideTriggers=[];d.showOn&&"creation"!==d.showOn&&this.showTriggers.push({element:this.triggerElement,event:d.showOn});null!=d.ajaxCache&&(d.cache=d.ajaxCache,delete d.ajaxCache);this.options=d;this.bound={};b=["prepareToShow","prepareToHide","show","hide","reposition"];g=0;for(a=b.length;a>g;g++)f=b[g],this.bound[f]=function(a){return function(){return k[a].apply(k,arguments)}}(f);this.adapter.domReady(function(){return k.activate(),
"creation"===k.options.showOn?k.prepareToShow():void 0})}return c.prototype.STICKS_OUT_TOP=1,c.prototype.STICKS_OUT_BOTTOM=2,c.prototype.STICKS_OUT_LEFT=1,c.prototype.STICKS_OUT_RIGHT=2,c.prototype["class"]={container:"opentip-container",opentip:"opentip",header:"ot-header",content:"ot-content",loadingIndicator:"ot-loading-indicator",close:"ot-close",goingToHide:"ot-going-to-hide",hidden:"ot-hidden",hiding:"ot-hiding",goingToShow:"ot-going-to-show",showing:"ot-showing",visible:"ot-visible",loading:"ot-loading",
...
function(a){var b,e,d,l,h,f,g,k,n,m;if(!((f=this.options.stem,d={position:a,stem:f},this.visible&&a)&&(g=this._sticksOut(a),g[0]||g[1])))return d;if(n=new c.Joint(this.options.tipJoint),this.options.targetJoint&&(k=new c.Joint(this.options.targetJoint)),this.adapter.scrollOffset(),m=this.adapter.viewportDimensions(),b=!1,m.width>=this.dimensions.width&&g[0])switch(b=!0,g[0]){case this.STICKS_OUT_LEFT:n.setHorizontal("left");this.options.targetJoint&&k.setHorizontal("right");break;case this.STICKS_OUT_RIGHT:n.setHorizontal("right"),
this.options.targetJoint&&k.setHorizontal("left")}if(m.height>=this.dimensions.height&&g[1])switch(b=!0,g[1]){case this.STICKS_OUT_TOP:n.setVertical("top");this.options.targetJoint&&k.setVertical("bottom");break;case this.STICKS_OUT_BOTTOM:n.setVertical("bottom"),this.options.targetJoint&&k.setVertical("top")}return b?(this.options.stem&&(f=n),a=this.getPosition(n,k,f),e=this._sticksOut(a),l=!1,h=!1,e[0]&&e[0]!==g[0]&&(l=!0,n.setHorizontal(this.options.tipJoint.horizontal),this.options.targetJoint&&
k.setHorizontal(this.options.targetJoint.horizontal)),e[1]&&e[1]!==g[1]&&(h=!0,n.setVertical(this.options.tipJoint.vertical),this.options.targetJoint&&k.setVertical(this.options.targetJoint.vertical)),l&&h?d:((l||h)&&(this.options.stem&&(f=n),a=this.getPosition(n,k,f)),{position:a,stem:f})):d},c.prototype._sticksOut=function(a){var b,e,d,c;return e=this.adapter.scrollOffset(),c=this.adapter.viewportDimensions(),b=[a.left-e[0],a.top-e[1]],d=[!1,!1],0>b[0]?d[0]=this.STICKS_OUT_LEFT:b[0]+this.dimensions.width>
c.width&&(d[0]=this.STICKS_OUT_RIGHT),0>b[1]?d[1]=this.STICKS_OUT_TOP:b[1]+this.dimensions.height>c.height&&(d[1]=this.STICKS_OUT_BOTTOM),d},c.prototype._draw=function(){var a,b,e,d,l,h,f,g,k,n,m,u,t,v,s,y,x,D,A,p=this;if(this.backgroundCanvas&&this.redraw){if(this.debug("Drawing background."),this.redraw=!1,this.currentStem){x=["top","right","bottom","left"];s=0;for(y=x.length;y>s;s++)u=x[s],this.adapter.removeClass(this.container,"stem-"+u);this.adapter.addClass(this.container,"stem-"+this.currentStem.horizontal);
this.adapter.addClass(this.container,"stem-"+this.currentStem.vertical)}return h=[0,0],f=[0,0],0<=__indexOf.call(this.options.hideTriggers,"closeButton")&&(l=new c.Joint("top right"===(null!=(D=this.currentStem)?D+"":void 0)?"top left":"top right"),h=[this.options.closeButtonRadius+this.options.closeButtonOffset[0],this.options.closeButtonRadius+this.options.closeButtonOffset[1]],f=[this.options.closeButtonRadius-this.options.closeButtonOffset[0],this.options.closeButtonRadius-this.options.closeButtonOffset[1]]),
...
d[1]-=Math.max(0,this.options.shadowBlur-this.options.shadowOffset[1])),b={left:0,right:0,top:0,bottom:0},this.currentStem&&(this.currentStem.left?b.left=this.options.stemLength:this.currentStem.right&&(b.right=this.options.stemLength),this.currentStem.top?b.top=this.options.stemLength:this.currentStem.bottom&&(b.bottom=this.options.stemLength)),l&&(l.left?b.left=Math.max(b.left,f[0]):l.right&&(b.right=Math.max(b.right,f[0])),l.top?b.top=Math.max(b.top,f[1]):l.bottom&&(b.bottom=Math.max(b.bottom,
f[1]))),e.width+=b.left+b.right,e.height+=b.top+b.bottom,d[0]-=b.left,d[1]-=b.top,this.currentStem&&this.options.borderWidth&&(A=this._getPathStemMeasures(this.options.stemBase,this.options.stemLength,this.options.borderWidth),v=A.stemLength,t=A.stemBase),a=this.adapter.unwrap(this.backgroundCanvas),a.width=e.width,a.height=e.height,this.adapter.css(this.backgroundCanvas,{width:""+a.width+"px",height:""+a.height+"px",left:""+d[0]+"px",top:""+d[1]+"px"}),g=a.getContext("2d"),g.setTransform(1,0,0,1,
0,0),g.clearRect(0,0,a.width,a.height),g.beginPath(),g.fillStyle=this._getColor(g,this.dimensions,this.options.background,this.options.backgroundGradientHorizontal),g.lineJoin="miter",g.miterLimit=500,m=this.options.borderWidth/2,this.options.borderWidth?(g.strokeStyle=this.options.borderColor,g.lineWidth=this.options.borderWidth):(v=this.options.stemLength,t=this.options.stemBase),null==t&&(t=0),n=function(a,b,e){return e&&g.moveTo(Math.max(t,p.options.borderRadius,h[0])+1-m,-m),b?(g.lineTo(a/2-
t/2,-m),g.lineTo(a/2,-v-m),g.lineTo(a/2+t/2,-m)):void 0},k=function(a,b,e){var d,c,f,w;return a?(g.lineTo(-t+m,0-m),g.lineTo(v+m,-v-m),g.lineTo(m,t-m)):b?(w=p.options.closeButtonOffset,f=h[0],0!==e%2&&(w=[w[1],w[0]],f=h[1]),d=Math.acos(w[1]/p.options.closeButtonRadius),c=Math.acos(w[0]/p.options.closeButtonRadius),g.lineTo(-f+m,-m),g.arc(m-w[0],-m+w[1],p.options.closeButtonRadius,-(Math.PI/2+d),c,!1)):(g.lineTo(-p.options.borderRadius+m,-m),g.quadraticCurveTo(m,-m,m,p.options.borderRadius-m))},g.translate(-d[0],
-d[1]),g.save(),function(){var a,b,e,d,f,h,w,B,C,F;F=[];b=B=0;for(C=c.positions.length/2;0<=C?C>B:B>C;b=0<=C?++B:--B)a=2*b,f=0===b||3===b?0:p.dimensions.width,h=2>b?0:p.dimensions.height,w=Math.PI/2*b,e=0===b%2?p.dimensions.width:p.dimensions.height,d=new c.Joint(c.positions[a]),a=new c.Joint(c.positions[a+1]),g.save(),g.translate(f,h),g.rotate(w),n(e,d.eql(p.currentStem),0===b),g.translate(e,0),k(a.eql(p.currentStem),a.eql(l),b),F.push(g.restore());return F}(),g.closePath(),g.save(),this.options.shadow&&
(g.shadowColor=this.options.shadowColor,g.shadowBlur=this.options.shadowBlur,g.shadowOffsetX=this.options.shadowOffset[0],g.shadowOffsetY=this.options.shadowOffset[1]),g.fill(),g.restore(),this.options.borderWidth&&g.stroke(),g.restore(),l?function(){var a,b,e;return"top right"==l+""?(e=[p.dimensions.width-p.options.closeButtonOffset[0],p.options.closeButtonOffset[1]],a=[e[0]+m,e[1]-m]):(e=[p.options.closeButtonOffset[0],p.options.closeButtonOffset[1]],a=[e[0]-m,e[1]-m]),g.translate(a[0],a[1]),b=
...
Opentip.prototype.setCss3Style=function(c,a){var b,e,d,l,h;c=this.adapter.unwrap(c);h=[];for(b in a)__hasProp.call(a,b)&&(e=a[b],null!=c.style[b]?h.push(c.style[b]=e):h.push(function(){var a,g,h;h=[];a=0;for(g=vendors.length;g>a;a++)d=vendors[a],l=""+this.ucfirst(d)+this.ucfirst(b),null!=c.style[l]?h.push(c.style[l]=e):h.push(void 0);return h}.call(this)));return h};Opentip.prototype.defer=function(c){return setTimeout(c,0)};Opentip.prototype.setTimeout=function(c,a){return setTimeout(c,a?1E3*a:0)};
...
Opentip.findElements=function(){var c,a,b,e,d,l,h,f,g,k;c=Opentip.adapter;g=c.findAll(document.body,"[data-ot]");k=[];h=0;for(f=g.length;f>h;h++){b=g[h];l={};a=c.data(b,"ot");""!==a&&"true"!==a&&"yes"!==a||(a=c.attr(b,"title"),c.attr(b,"title",""));a=a||"";for(e in Opentip.styles.standard)d=c.data(b,"ot"+Opentip.prototype.ucfirst(e)),null!=d&&("yes"===d||"true"===d||"on"===d?d=!0:("no"===d||"false"===d||"off"===d)&&(d=!1),l[e]=d);k.push(new Opentip(b,a,l))}return k};Opentip.version="2.4.6";
Opentip.debug=!1;Opentip.lastId=0;Opentip.lastZIndex=100;Opentip.tips=[];Opentip._abortShowingGroup=function(c,a){var b,e,d,l,h;l=Opentip.tips;h=[];e=0;for(d=l.length;d>e;e++)b=l[e],b!==a&&b.options.group===c?h.push(b._abortShowing()):h.push(void 0);return h};Opentip._hideGroup=function(c,a){var b,e,d,l,h;l=Opentip.tips;h=[];e=0;for(d=l.length;d>e;e++)b=l[e],b!==a&&b.options.group===c?h.push(b.hide()):h.push(void 0);return h};Opentip.adapters={};Opentip.adapter=null;firstAdapter=!0;
...
document.createElement("canvas").getContext||function(){function c(){return this.context_||(this.context_=new k(this))}function a(a,b){var c=G.call(arguments,2);return function(){return a.apply(b,c.concat(G.call(arguments)))}}function b(a){var b=a.srcElement;switch(a.propertyName){case "width":b.style.width=b.attributes.width.nodeValue+"px";b.getContext().clearRect();break;case "height":b.style.height=b.attributes.height.nodeValue+"px",b.getContext().clearRect()}}function e(a){a=a.srcElement;a.firstChild&&
(a.firstChild.style.width=a.clientWidth+"px",a.firstChild.style.height=a.clientHeight+"px")}function d(){return[[1,0,0],[0,1,0],[0,0,1]]}function l(a,b){for(var c=d(),e=0;3>e;e++)for(var f=0;3>f;f++){for(var g=0,h=0;3>h;h++)g+=a[e][h]*b[h][f];c[e][f]=g}return c}function h(a,b){b.fillStyle=a.fillStyle;b.lineCap=a.lineCap;b.lineJoin=a.lineJoin;b.lineWidth=a.lineWidth;b.miterLimit=a.miterLimit;b.shadowBlur=a.shadowBlur;b.shadowColor=a.shadowColor;b.shadowOffsetX=a.shadowOffsetX;b.shadowOffsetY=a.shadowOffsetY;
b.strokeStyle=a.strokeStyle;b.globalAlpha=a.globalAlpha;b.arcScaleX_=a.arcScaleX_;b.arcScaleY_=a.arcScaleY_;b.lineScale_=a.lineScale_}function f(a){var b,c=1;if(a+="","rgb"==a.substring(0,3)){b=a.indexOf("(",3);var d=a.indexOf(")",b+1),d=a.substring(b+1,d).split(",");b="#";for(var e=0;3>e;e++)b+=I[Number(d[e])];4==d.length&&"a"==a.substr(3,1)&&(c=d[3])}else b=a;return{color:b,alpha:c}}function g(a){switch(a){case "butt":return"flat";case "round":return"round";default:return"square"}}function k(a){this.m_=
d();this.mStack_=[];this.aStack_=[];this.currentPath_=[];this.fillStyle=this.strokeStyle="#000";this.lineWidth=1;this.lineJoin="miter";this.lineCap="butt";this.miterLimit=1*p;this.globalAlpha=1;this.canvas=a;var b=a.ownerDocument.createElement("div");b.style.width=a.clientWidth+"px";b.style.height=a.clientHeight+"px";b.style.position="absolute";a.appendChild(b);this.element_=b;this.lineScale_=this.arcScaleY_=this.arcScaleX_=1}function n(a,b,c,d){a.currentPath_.push({type:"bezierCurveTo",cp1x:b.x,
cp1y:b.y,cp2x:c.x,cp2y:c.y,x:d.x,y:d.y});a.currentX_=d.x;a.currentY_=d.y}function m(a,b,c){var d;a:{for(d=0;3>d;d++)for(var e=0;2>e;e++)if(!isFinite(b[d][e])||isNaN(b[d][e])){d=!1;break a}d=!0}d&&(a.m_=b,c)&&(a.lineScale_=A(D(b[0][0]*b[1][1]-b[0][1]*b[1][0])))}function u(a){this.type_=a;this.r1_=this.y1_=this.x1_=this.r0_=this.y0_=this.x0_=0;this.colors_=[]}function t(){}var v=Math,s=v.round,y=v.sin,x=v.cos,D=v.abs,A=v.sqrt,p=10,z=p/2,G=Array.prototype.slice,H={init:function(b){/MSIE/.test(navigator.userAgent)&&
...
a.getElementsByTagName("canvas");for(b=0;a.length>b;b++)this.initElement(a[b])},initElement:function(a){if(!a.getContext){a.getContext=c;a.innerHTML="";a.attachEvent("onpropertychange",b);a.attachEvent("onresize",e);var d=a.attributes;d.width&&d.width.specified?a.style.width=d.width.nodeValue+"px":a.width=a.clientWidth;d.height&&d.height.specified?a.style.height=d.height.nodeValue+"px":a.height=a.clientHeight}return a}};H.init();for(var I=[],r=0;16>r;r++)for(var E=0;16>E;E++)I[16*r+E]=r.toString(16)+
E.toString(16);r=k.prototype;r.clearRect=function(){this.element_.innerHTML=""};r.beginPath=function(){this.currentPath_=[]};r.moveTo=function(a,b){var c=this.getCoords_(a,b);this.currentPath_.push({type:"moveTo",x:c.x,y:c.y});this.currentX_=c.x;this.currentY_=c.y};r.lineTo=function(a,b){var c=this.getCoords_(a,b);this.currentPath_.push({type:"lineTo",x:c.x,y:c.y});this.currentX_=c.x;this.currentY_=c.y};r.bezierCurveTo=function(a,b,c,d,e,f){e=this.getCoords_(e,f);a=this.getCoords_(a,b);c=this.getCoords_(c,
d);n(this,a,c,e)};r.quadraticCurveTo=function(a,b,c,d){a=this.getCoords_(a,b);c=this.getCoords_(c,d);d={x:this.currentX_+2/3*(a.x-this.currentX_),y:this.currentY_+2/3*(a.y-this.currentY_)};n(this,d,{x:d.x+(c.x-this.currentX_)/3,y:d.y+(c.y-this.currentY_)/3},c)};r.arc=function(a,b,c,d,e,f){c*=p;var g=f?"at":"wa",h=a+x(d)*c-z,m=b+y(d)*c-z;d=a+x(e)*c-z;e=b+y(e)*c-z;h!=d||f||(h+=0.125);a=this.getCoords_(a,b);h=this.getCoords_(h,m);d=this.getCoords_(d,e);this.currentPath_.push({type:g,x:a.x,y:a.y,radius:c,
xStart:h.x,yStart:h.y,xEnd:d.x,yEnd:d.y})};r.rect=function(a,b,c,d){this.moveTo(a,b);this.lineTo(a+c,b);this.lineTo(a+c,b+d);this.lineTo(a,b+d);this.closePath()};r.strokeRect=function(a,b,c,d){var e=this.currentPath_;this.beginPath();this.moveTo(a,b);this.lineTo(a+c,b);this.lineTo(a+c,b+d);this.lineTo(a,b+d);this.closePath();this.stroke();this.currentPath_=e};r.fillRect=function(a,b,c,d){var e=this.currentPath_;this.beginPath();this.moveTo(a,b);this.lineTo(a+c,b);this.lineTo(a+c,b+d);this.lineTo(a,
b+d);this.closePath();this.fill();this.currentPath_=e};r.createLinearGradient=function(a,b,c,d){var e=new u("gradient");return e.x0_=a,e.y0_=b,e.x1_=c,e.y1_=d,e};r.createRadialGradient=function(a,b,c,d,e,f){var g=new u("gradientradial");return g.x0_=a,g.y0_=b,g.r0_=c,g.x1_=d,g.y1_=e,g.r1_=f,g};r.drawImage=function(a){var b,c,d,e,f,g,h,m;d=a.runtimeStyle.width;e=a.runtimeStyle.height;a.runtimeStyle.width="auto";a.runtimeStyle.height="auto";var q=a.width,k=a.height;if(a.runtimeStyle.width=d,a.runtimeStyle.height=
e,3==arguments.length)b=arguments[1],c=arguments[2],f=g=0,h=d=q,m=e=k;else if(5==arguments.length)b=arguments[1],c=arguments[2],d=arguments[3],e=arguments[4],f=g=0,h=q,m=k;else{if(9!=arguments.length)throw Error("Invalid number of arguments");f=arguments[1];g=arguments[2];h=arguments[3];m=arguments[4];b=arguments[5];c=arguments[6];d=arguments[7];e=arguments[8]}var l=this.getCoords_(b,c),n=[];if(n.push(" <g_vml_:group",' coordsize="',10*p,",",10*p,'"',' coordorigin="0,0"',' style="width:',10,"px;height:",
10,"px;position:absolute;"),1!=this.m_[0][0]||this.m_[0][1]){var r=[];r.push("M11=",this.m_[0][0],",","M12=",this.m_[1][0],",","M21=",this.m_[0][1],",","M22=",this.m_[1][1],",","Dx=",s(l.x/p),",","Dy=",s(l.y/p),"");var t=this.getCoords_(b+d,c),u=this.getCoords_(b,c+e);b=this.getCoords_(b+d,c+e);l.x=v.max(l.x,t.x,u.x,b.x);l.y=v.max(l.y,t.y,u.y,b.y);n.push("padding:0 ",s(l.x/p),"px ",s(l.y/p),"px 0;filter:progid:DXImageTransform.Microsoft.Matrix(",r.join(""),", sizingmethod='clip');")}else n.push("top:",
s(l.y/p),"px;left:",s(l.x/p),"px;");n.push(' ">','<g_vml_:image src="',a.src,'"',' style="width:',p*d,"px;"," height:",p*e,'px;"',' cropleft="',f/q,'"',' croptop="',g/k,'"',' cropright="',(q-f-h)/q,'"',' cropbottom="',(k-g-m)/k,'"'," />","</g_vml_:group>");this.element_.insertAdjacentHTML("BeforeEnd",n.join(""))};r.stroke=function(a){var b=[],c=f(a?this.fillStyle:this.strokeStyle),d=c.color,c=c.alpha*this.globalAlpha;b.push("<g_vml_:shape",' filled="',!!a,'"',' style="position:absolute;width:',10,
"px;height:",10,'px;"',' coordorigin="0 0" coordsize="',10*p," ",10*p,'"',' stroked="',!a,'"',' path="');for(var e=null,h=null,l=null,m=null,k=0;this.currentPath_.length>k;k++){var q=this.currentPath_[k];switch(q.type){case "moveTo":b.push(" m ",s(q.x),",",s(q.y));break;case "lineTo":b.push(" l ",s(q.x),",",s(q.y));break;case "close":b.push(" x ");q=null;break;case "bezierCurveTo":b.push(" c ",s(q.cp1x),",",s(q.cp1y),",",s(q.cp2x),",",s(q.cp2y),",",s(q.x),",",s(q.y));break;case "at":case "wa":b.push(" ",
q.type," ",s(q.x-this.arcScaleX_*q.radius),",",s(q.y-this.arcScaleY_*q.radius)," ",s(q.x+this.arcScaleX_*q.radius),",",s(q.y+this.arcScaleY_*q.radius)," ",s(q.xStart),",",s(q.yStart)," ",s(q.xEnd),",",s(q.yEnd))}q&&((null==e||e>q.x)&&(e=q.x),(null==l||q.x>l)&&(l=q.x),(null==h||h>q.y)&&(h=q.y),(null==m||q.y>m)&&(m=q.y))}if(b.push(' ">'),a)if("object"==typeof this.fillStyle){var d=this.fillStyle,n=0,q=c=a=0,r=1;"gradient"==d.type_?(n=d.x1_/this.arcScaleX_,e=d.y1_/this.arcScaleY_,k=this.getCoords_(d.x0_/
this.arcScaleX_,d.y0_/this.arcScaleY_),n=this.getCoords_(n,e),n=180*Math.atan2(n.x-k.x,n.y-k.y)/Math.PI,0>n&&(n+=360),1E-6>n&&(n=0)):(k=this.getCoords_(d.x0_,d.y0_),q=l-e,r=m-h,a=(k.x-e)/q,c=(k.y-h)/r,q/=this.arcScaleX_*p,r/=this.arcScaleY_*p,k=v.max(q,r),q=2*d.r0_/k,r=2*d.r1_/k-q);e=d.colors_;e.sort(function(a,b){return a.offset-b.offset});for(var h=e.length,m=e[0].color,l=e[h-1].color,t=e[0].alpha*this.globalAlpha,u=e[h-1].alpha*this.globalAlpha,x=[],k=0;h>k;k++){var y=e[k];x.push(y.offset*r+q+
" "+y.color)}b.push('<g_vml_:fill type="',d.type_,'"',' method="none" focus="100%"',' color="',m,'"',' color2="',l,'"',' colors="',x.join(","),'"',' opacity="',u,'"',' g_o_:opacity2="',t,'"',' angle="',n,'"',' focusposition="',a,",",c,'" />')}else b.push('<g_vml_:fill color="',d,'" opacity="',c,'" />');else a=this.lineScale_*this.lineWidth,1>a&&(c*=a),b.push("<g_vml_:stroke",' opacity="',c,'"',' joinstyle="',this.lineJoin,'"',' miterlimit="',this.miterLimit,'"',' endcap="',g(this.lineCap),'"',' weight="',
a,'px"',' color="',d,'" />');b.push("</g_vml_:shape>");this.element_.insertAdjacentHTML("beforeEnd",b.join(""))};r.fill=function(){this.stroke(!0)};r.closePath=function(){this.currentPath_.push({type:"close"})};r.getCoords_=function(a,b){var c=this.m_;return{x:p*(a*c[0][0]+b*c[1][0]+c[2][0])-z,y:p*(a*c[0][1]+b*c[1][1]+c[2][1])-z}};r.save=function(){var a={};h(this,a);this.aStack_.push(a);this.mStack_.push(this.m_);this.m_=l(d(),this.m_)};r.restore=function(){h(this.aStack_.pop(),this);this.m_=this.mStack_.pop()};
r.translate=function(a,b){m(this,l([[1,0,0],[0,1,0],[a,b,1]],this.m_),!1)};r.rotate=function(a){var b=x(a);a=y(a);m(this,l([[b,a,0],[-a,b,0],[0,0,1]],this.m_),!1)};r.scale=function(a,b){this.arcScaleX_*=a;this.arcScaleY_*=b;m(this,l([[a,0,0],[0,b,0],[0,0,1]],this.m_),!0)};r.transform=function(a,b,c,d,e,f){m(this,l([[a,b,0],[c,d,0],[e,f,1]],this.m_),!0)};r.setTransform=function(a,b,c,d,e,f){m(this,[[a,b,0],[c,d,0],[e,f,1]],!0)};r.clip=function(){};r.arcTo=function(){};r.createPattern=function(){return new t};
u.prototype.addColorStop=function(a,b){b=f(b);this.colors_.push({offset:a,color:b.color,alpha:b.alpha})};G_vmlCanvasManager=H;CanvasRenderingContext2D=k;CanvasGradient=u;CanvasPattern=t}();