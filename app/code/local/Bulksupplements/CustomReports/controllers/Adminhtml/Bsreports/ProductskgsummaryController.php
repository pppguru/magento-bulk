<?php
class Bulksupplements_CustomReports_Adminhtml_BsReports_ProductskgsummaryController extends Mage_Adminhtml_Controller_Action {
	...
	*/
	protected function _isAllowed() {
		return Mage::getSingleton('admin/session')->isAllowed('report/productskgsummary');
	}
	...
	public function exportCsvAction() {
		...
		$fileName = 'products_kg_summary_report.csv';
		$content = $this->getLayout()->createBlock('customreports/adminhtml_productskgsummary_grid')
		   ->getCsv();
