...
class Bulksupplements_Adminhtml_Catalog_ProductController extends Mage_Adminhtml_Catalog_ProductController
{
...
//           $product->setPrice($product->getPrice() + $additionalPrice); // by default
           $product->setPrice($additionalPrice);     // Matthew : configurable price work
           $product->unsPricing();
        }
