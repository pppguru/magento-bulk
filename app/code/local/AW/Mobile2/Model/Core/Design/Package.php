...
class AW_Mobile2_Model_Core_Design_Package extends Mage_Core_Model_Design_Package
{
    protected function _checkUserAgentAgainstRegexps($regexpsConfigPath)
    {
        ...
        if ($regexpsConfigPath == 'design/package/ua_regexp') {
            return AW_Mobile2_Helper_Data::IPHONE_PACKAGE_NAME;
        }
        return AW_Mobile2_Helper_Data::IPHONE_THEME_NAME;
    }
    ...
    public function setPackageName($name = '')
    {
        ...
        return parent::setPackageName(AW_Mobile2_Helper_Data::IPHONE_PACKAGE_NAME);
    }
    ...
    public function setTheme()
    {
        ...
        return parent::setTheme(AW_Mobile2_Helper_Data::IPHONE_THEME_NAME);
    }
}