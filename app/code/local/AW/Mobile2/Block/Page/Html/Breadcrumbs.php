...
class AW_Mobile2_Block_Page_Html_Breadcrumbs extends Mage_Page_Block_Html_Breadcrumbs
{
    ...
    protected function _isCMSHomePage()
    {
        ...
        if ($page->getIdentifier() !== AW_Mobile2_Helper_Config::getIPadHomePageId()) {
            return false;
        }
        return true;
    }
    ...
    {
        if (!AW_Mobile2_Helper_Config::getIPadHomePageId()) {
            return $this;
        }
        $crumbInfo['link'] = Mage::helper('cms/page')->getPageUrl(
            AW_Mobile2_Helper_Config::getIPadHomePageId()
        );
    }
}