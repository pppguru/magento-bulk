    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    protected function _initForm()
    {
        ...
        $fTemplates->addField(
            'new_from_admin_to_customer', 'select',
            array(
        ...
        $fTemplates->addField(
            'to_customer_reply_email', 'select',
            array(
        ...
        $fTemplates->addField(
            'to_admin_reassign_email', 'select',
            array(
        ...
        $fTemplates->addField(
            'to_customer_reassign_email', 'select',
            array(
