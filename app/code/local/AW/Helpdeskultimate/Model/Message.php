...
class AW_Helpdeskultimate_Model_Message extends AW_Core_Model_Abstract
{
    ...
    public function getAdminFileUrl($file)
    {
        ...
        if (method_exists(Mage::getSingleton('adminhtml/url'), 'getUrl')) {
            return Mage::getSingleton('adminhtml/url')->getUrl('*/*/downloadmsg', $params);
        } else {
    ...
    public function getParsedContent()
    {
        ...
        $departmentVariable->setData($this->getTicket()->getDepartment()->getData());
        $tf
