...
if (Mage::getStoreConfig(AW_Helpdeskultimate_Helper_Config::XML_PATH_SELF_EMAIL) == Mage::getStoreConfig(AW_Helpdeskultimate_Helper_Config::XML_PATH_CF_EMAIL)) {
    // Restore
        ...
        Mage::getModel('adminhtml/config_data')
            ...
            ->setGroups(
                array(
                     'email' => array(
                         'fields' => array(
                             'recipient_email' => array('value' => Mage::getStoreConfig(
                                 AW_Helpdeskultimate_Helper_Config::XML_PATH_STORED_CF_EMAIL
                             ))
                         )
                     )
                )
