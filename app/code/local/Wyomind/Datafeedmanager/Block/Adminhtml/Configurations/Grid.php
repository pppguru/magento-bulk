...
class Wyomind_Datafeedmanager_Block_Adminhtml_Configurations_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('feed_type', array(
            ...
            'renderer' => 'Wyomind_Datafeedmanager_Block_Adminhtml_Configurations_Renderer_Type',
        ));
        ...
        $this->addColumn('feed_link', array(
            ...
            'filter' => false,
            'sortable' => false,
            'renderer' => 'Wyomind_Datafeedmanager_Block_Adminhtml_Configurations_Renderer_Link',
        ));
        ...
        $this->addColumn('feed_status', array(
            ...
            'renderer' => 'Wyomind_Datafeedmanager_Block_Adminhtml_Configurations_Renderer_Status',
        ));
        ...
        $this->addColumn('action', array(
            ...
            'filter' => false,
            'sortable' => false,
            'renderer' => 'Wyomind_Datafeedmanager_Block_Adminhtml_Configurations_Renderer_Action',
        ));
