...
class Wyomind_Googletrustedstores_Block_Adminhtml_System_Config_Form_Field_Dynamicshipmentlink extends Mage_Adminhtml_Block_System_Config_Form_Field {
    ...
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element) {
        ...
        $url_ship = Mage::getUrl('googletrustedstores/generate/shipments/', array('website' => $website->getId(),'ak'=>$ak));
