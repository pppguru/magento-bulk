        ...
        foreach ($this->_order->getAllItems() as $orderItem) {
            ...
            if ($orderItem->isDummy(true)) {
                ...
                if (isset($qtys[$orderItem->getParentItemId()])) {
                    ...
                    {
                        //BMS - BoosMyShop tweak to add configurable child in shipment
                        //if there is a parent and no bundle selection, apply parent quantity (used for configurable products)
                        $qty = $qtys[$orderItem->getParentItemId()];
                    }
                } else {
                    $qty = 1;
                }
