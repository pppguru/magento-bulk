...
ALTER TABLE `ewcrawler_job` 
	ADD COLUMN `num_custom_urls` int(11)   NULL after `num_crawled_urls` , 
	...
	CHANGE `last_crawl_activity_at` `last_crawl_activity_at` datetime   NULL after `using_extendware_page_cache` , 
