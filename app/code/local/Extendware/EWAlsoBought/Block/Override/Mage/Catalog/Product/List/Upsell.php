<?php
class Extendware_EWAlsoBought_Block_Override_Mage_Catalog_Product_List_Upsell extends Extendware_EWAlsoBought_Block_Override_Mage_Catalog_Product_List_Upsell_Bridge
{
	protected $blockType = 'upsells';
	...
	protected function callDefaultPrepareData($caller) {
		if ($caller == 'ewalsoviewed') {
			return Mage_Catalog_Block_Product_List_UpsellOverriddenClass::_prepareData();
		}
