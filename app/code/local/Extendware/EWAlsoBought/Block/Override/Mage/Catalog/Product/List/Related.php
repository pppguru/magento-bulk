<?php
class Extendware_EWAlsoBought_Block_Override_Mage_Catalog_Product_List_Related extends Extendware_EWAlsoBought_Block_Override_Mage_Catalog_Product_List_Related_Bridge
{
	...
	protected function callDefaultPrepareData($caller) {
		if ($caller == 'ewalsoviewed') {
			return Mage_Catalog_Block_Product_List_RelatedOverriddenClass::_prepareData();
		}
