...
if  (Mage::helper('wsalogger')->getNewVersion() > 10 ) {
    ...
    if(!$installer->getConnection()->tableColumnExists($orderTable, 'original_shipping_method')){
        $installer->run("
            ALTER IGNORE TABLE {$orderTable} ADD original_shipping_method TEXT NULL COMMENT 'WebShopApps FreightCommon';
        ");
    }
}
