 ...
 */
class MDN_AdvancedStock_Block_Warehouse_Edit_Tabs_ImportShelfLocation extends Mage_Adminhtml_Block_Widget_Form
{
	private $_stock = null;
	...
	public function __construct()
	{
		...
		$this->setTemplate('AdvancedStock/Warehouse/Edit/Tab/ImportShelfLocation.phtml');
	}
