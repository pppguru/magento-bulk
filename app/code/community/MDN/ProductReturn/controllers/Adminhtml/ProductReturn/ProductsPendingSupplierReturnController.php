...
class MDN_ProductReturn_Adminhtml_ProductReturn_ProductsPendingSupplierReturnController extends Mage_Adminhtml_Controller_Action
{
    /* Action */
    ...
    public function AddProductAction()
    {
        ...
        if ($warehouseId != null && Mage::getModel('catalog/product')->load($productId)->getId()) {
