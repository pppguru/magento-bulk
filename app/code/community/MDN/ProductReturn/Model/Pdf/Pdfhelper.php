...
abstract class MDN_ProductReturn_Model_Pdf_Pdfhelper extends Mage_Sales_Model_Order_Pdf_Abstract
{
    ...
    protected function getFooterHeight(){
        ...
        $footerTxt = Mage::getStoreConfig('productreturn/pdf/footer_text');
        $lines = explode("\n", $footerTxt);
    ...
    public function drawFooter(&$page)
    {
        ...
        $page->drawRectangle(10, $this->getFooterHeight() + 15, $this->_BLOC_FOOTER_LARGEUR, 15, Zend_Pdf_Page::SHAPE_DRAW_FILL);

        //rajoute le texte
        $page->setFillColor(new Zend_Pdf_Color_GrayScale(0.2));
        $footerHeight = $this->DrawMultilineText($page, Mage::getStoreConfig('productreturn/pdf/footer_text'), 20, $this->getFooterHeight(), 10, 0, 15);
    ...
    public function drawHeader(&$page, $title, $StoreId = null)
    {
        ...
        $this->_BLOC_ENTETE_HAUTEUR = $this->DrawMultilineText($page, Mage::getStoreConfig('productreturn/pdf/header_text', $StoreId), 300, $this->y - 10, 10, 0, 15) + 15;
    ...
    public function AddAddressesBlock(&$page, $LeftAddress, $RightAddress, $TxtDate, $TxtInfo)
    {
        ...
        $this->y -= 20;
        $leftAddressHeight = $this->DrawMultilineText($page, $LeftAddress, 25, $this->y, 14, 0.4, 16);
        $rightAddressHeight = $this->DrawMultilineText($page, $RightAddress, $this->_PAGE_WIDTH / 2 + 10, $this->y, 14, 0.4, 16);
        $offset = max($leftAddressHeight, $rightAddressHeight);
        ...
        $page->drawLine($this->_PAGE_WIDTH / 2, $this->y + $offset + 50, $this->_PAGE_WIDTH / 2, $this->y);
    }
