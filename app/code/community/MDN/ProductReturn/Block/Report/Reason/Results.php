 ...
 */
class MDN_ProductReturn_Block_Report_Reason_Results extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection = Mage::getResourceModel('ProductReturn/Period_collection')->getReasonReport();
