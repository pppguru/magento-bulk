...
class MDN_BackgroundTask_Block_Task_GroupExecute extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    {
    	return $this->getUrl('adminhtml/BackgroundTask_Admin/AjaxExecuteTaskGroup', array('group_code' => $this->_groupCode));
    }
    
    public function getFinishedUrl()
    {
    	return $this->getUrl('adminhtml/BackgroundTask_Admin/confirmTaskGroupExecution', array('group_code' => $this->_groupCode));
    }
