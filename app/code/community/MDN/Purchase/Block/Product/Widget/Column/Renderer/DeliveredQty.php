 ...
 */
class MDN_Purchase_Block_Product_Widget_Column_Renderer_DeliveredQty extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract
{
    public function render(Varien_Object $row)
    {
        $value = $row->getpop_supplied_qty();
