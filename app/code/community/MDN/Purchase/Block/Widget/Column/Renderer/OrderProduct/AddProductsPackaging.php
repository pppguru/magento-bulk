 ...
 */
class MDN_Purchase_Block_Widget_Column_Renderer_OrderProduct_AddProductsPackaging extends MDN_Purchase_Block_Widget_Column_Renderer_OrderProduct_Abstract {
