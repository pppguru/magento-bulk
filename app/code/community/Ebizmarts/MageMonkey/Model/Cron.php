...
class Ebizmarts_MageMonkey_Model_Cron
{
	...
	public function bulksyncExportSubscribers()
    {
		...
		// Filter Customer Email except marketplace.amazon.com code Started

		$collection->addFieldToFilter('email', array('nlike' => '%@marketplace.amazon.com'));
		//echo $collection->getSelect();
			
		// Filter Subscriber Email except marketplace.amazon.com code Ended
